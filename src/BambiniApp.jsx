...
/* ═══════════════════════════════════════════════════════════════
   🧠 BRAIN INFOGRAPHIC INTERATTIVA (VERSIONE DEFINITIVA PNG)
═══════════════════════════════════════════════════════════════ */
...
const BRAIN_CONTENT = {
  ...
  // Aggiungi qui le altre fasce d'età seguendo lo stesso schema...
};
...
export function BrainInfographic({ zone = "0-3" }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: "30px" }}>
        <h2 style={{ fontSize: "28px", color: "#2D242E" }}>{data.title}</h2>
        <p style={{ color: "#7A6B7C", fontStyle: "italic" }}>Tocca le aree colorate per scoprire come si sviluppano</p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: "30px", alignItems: "center" }}>
        ...
        <div style={{ flex: 1, position: "relative", width: "100%" }}>
          ...
          {/* ZONE CLICCABILI (Coordinate basate su immagine standard) */}
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <span>{lobe.icon}</span>
                  <strong>{lobe.label}</strong>
                </div>
                {isActive && <p style={{ fontSize: "14px", marginTop: "10px", lineHeight: "1.5" }}>{data.lobes[key]}</p>}
              </div>
            );
          })}
          {activeLobe && (
            <button onClick={() => setActiveLobe(null)} style={{ width: "100%", padding: "10px", border: "none", borderRadius: "10px", cursor: "pointer" }}>
              Mostra tutto
            </button>
          )}
        </div>
