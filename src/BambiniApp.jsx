/* La Bebi App v3.0 — gravidanza + 12-18 anni + sezione genitori */
  ...
  return (
    <div style={{ background: "#FFFCFA", minHeight: "100vh" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "44px 20px" }}>
        ...
        {/* Content tabs */}
        <div style={{ background: "white", borderRadius: 32, overflow: "hidden", boxShadow: "0 4px 20px rgba(200,120,140,0.10)", border: `1px solid ${COLORS.sageLight}` }}>
          <div style={{ display: "flex", borderBottom: `2px solid ${COLORS.sageLight}`, overflowX: "auto" }}>
            {tabs.map(tab => (
        ...
        <div style={{ marginTop: 48, background: COLORS.deepSlate, borderRadius: 32, padding: 36 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fill, minmax(200px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={i} style={{ background: "rgba(255,255,255,0.06)", borderRadius: 28, padding: 20 }}>
                <div style={{
            ...
            return (
              <div key={i} role="button" tabIndex={0} onClick={() => setOpenForum(openForum === i ? null : i)}
                ...
                <div style={{ padding: "22px 20px" }}>
                  ...
                  <div style={{ ...sty, color: "rgba(255,255,255,0.75)", fontSize: 12, fontStyle: "italic", marginBottom: 10 }}>{t.rank}</div>
                  <div style={{ ...sty, color: "rgba(255,255,255,0.88)", fontSize: 14, lineHeight: 1.6 }}>{t.desc}</div>
                  <div style={{ marginTop: 14, ...sty, color: "rgba(255,255,255,0.62)", fontSize: 13 }}>
                ...
                {openForum === i && (
                  <div style={{ borderTop: "1px solid rgba(255,255,255,0.2)" }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: 10, padding: "16px 20px" }}>
                      {t.idea.split("\n\n").map((para, pi) => (
                        <div key={pi} style={{
                          background: pi === 0 ? "rgba(255,255,255,0.18)" : "rgba(255,255,255,0.10)",
    ...
    <div style={{ background: COLORS.warmWhite, minHeight: "100vh" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "32px 16px" : "48px 24px" }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#E3F2FD", color: "#1565C0", borderRadius: 50, padding: "6px 16px", fontSize: 13, fontWeight: 800, marginBottom: 14 }}>
            🌊 12–15 anni · Preadolescenza
          </div>
          <h2 style={{ fontFamily: "'Playfair Display', serif", color: COLORS.deepSlate, fontSize: isMobile ? 26 : 36, marginBottom: 8, lineHeight: 1.2 }}>
...
function AdolescenzaPage() {
  ...
  return (
    <div style={{ background: COLORS.warmWhite, minHeight: "100vh" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "32px 16px" : "48px 24px" }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: COLORS.goldLight, color: "#7A5A00", borderRadius: 50, padding: "6px 16px", fontSize: 13, fontWeight: 800, marginBottom: 14 }}>
            🌟 15–18 anni · Adolescenza
          </div>
          <h2 style={{ fontFamily: "'Playfair Display', serif", color: COLORS.deepSlate, fontSize: isMobile ? 26 : 36, marginBottom: 8, lineHeight: 1.2 }}>
            Adolescenza — Costruire un adulto
          </h2>
          <p style={{ fontFamily: "'Nunito', sans-serif", color: COLORS.slateLight, fontSize: 16, lineHeight: 1.75 }}>
...
function GravidanzaPage() {
  ...
  return (
    <div style={{ background: COLORS.warmWhite, minHeight: "100vh" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: isMobile ? "32px 16px" : "48px 24px" }}>
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: COLORS.roseLight, color: COLORS.roseDark, borderRadius: 50, padding: "6px 16px", fontSize: 13, fontWeight: 800, marginBottom: 14 }}>
            🤰 In attesa del bambino
          </div>
          <h2 style={{ fontFamily: "'Playfair Display', serif", color: COLORS.deepSlate, fontSize: isMobile ? 26 : 36, marginBottom: 8, lineHeight: 1.2 }}>
            Gravidanza — Il viaggio prima del viaggio
          </h2>
          <p style={{ fontFamily: "'Nunito', sans-serif", color: COLORS.slateLight, fontSize: 16, lineHeight: 1.75 }}>
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Nunito', Georgia, sans-serif", background: COLORS.cream, minHeight: "100vh" }}>
      ...
      {section === "home" && <HomePage setActiveSection={setSection} zone={zone} setZone={setZone} />}
      {section === "guide" && (
