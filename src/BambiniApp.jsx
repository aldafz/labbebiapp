  ...
  const content = {
    ...
    emozioni: {
      ...
      cards: [
        ...
        { icon: "😰", titolo: "L'ansia come compagna fissa", testo: "Il 20% dei preadolescenti ha livelli significativi di ansia. L'ansia da prestazione scolastica, l'ansia sociale, la paura del giudizio sono tra le più frequenti. Spesso non riescono a nominarla — la [[ansia somatica|somatizzano]]: mal di pancia, mal di testa, insonnia." },
    ...
    relazioni: {
      ...
      cards: [
        ...
        { icon: "💔", titolo: "Esclusione e bullismo: effetti reali", testo: "Un bambino escluso dal gruppo non sta esagerando quando dice che gli fa male. L'esclusione sociale attiva le stesse aree cerebrali del dolore fisico ([[Eisenberger]], 2003). Il [[bullismo e vittimizzazione|bullismo]] — fisico, verbale o digitale — in questa fase lascia tracce neurologiche misurabili." },
